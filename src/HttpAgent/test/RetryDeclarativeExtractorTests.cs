...
public class RetryDeclarativeExtractorTests
{
    ...
    public void Extract_ReturnOK()
    {
        ...
        var context1 = new HttpDeclarativeParsingContext(method1, [],
            new HttpDeclarativeMetadata(method1, typeof(IRetryDeclarativeExtractorTest1)));
        ...
        var context2 = new HttpDeclarativeParsingContext(method2, [],
            new HttpDeclarativeMetadata(method2, typeof(IRetryDeclarativeExtractorTest2)));
        ...
        var context3 = new HttpDeclarativeParsingContext(method3, [],
            new HttpDeclarativeMetadata(method3, typeof(IRetryDeclarativeExtractorTest2)));
