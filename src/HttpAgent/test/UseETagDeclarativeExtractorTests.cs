...
public class UseETagDeclarativeExtractorTests
{
    ...
    public void Extract_ReturnOK()
    {
        ...
        var context1 = new HttpDeclarativeExtractorContext(method1, [],
            new HttpDeclarativeMethodMetadata(method1, typeof(IUseETagDeclarativeExtractorTest1)));
        ...
        var context2 = new HttpDeclarativeExtractorContext(method2, [],
            new HttpDeclarativeMethodMetadata(method2, typeof(IUseETagDeclarativeExtractorTest2)));
        ...
        var context3 = new HttpDeclarativeExtractorContext(method3, [],
            new HttpDeclarativeMethodMetadata(method3, typeof(IUseETagDeclarativeExtractorTest2)));
