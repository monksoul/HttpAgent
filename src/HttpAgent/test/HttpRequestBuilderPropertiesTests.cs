...
public class HttpRequestBuilderPropertiesTests
{
    ...
    public void New_ReturnOK()
    {
        ...
        Assert.Null(httpRequestBuilder2.ReplacedQueryParameterKeys);
