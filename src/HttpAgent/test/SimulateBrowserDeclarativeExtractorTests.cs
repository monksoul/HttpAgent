...
public class SimulateBrowserDeclarativeExtractorTests
{
    ...
    public void Extract_ReturnOK()
    {
        ...
        var context1 = new HttpDeclarativeParsingContext(method1, [],
            new HttpDeclarativeMetadata(method1, typeof(ISimulateBrowserDeclarativeExtractorTest1)));
        ...
        var context2 = new HttpDeclarativeParsingContext(method2, [],
            new HttpDeclarativeMetadata(method2, typeof(ISimulateBrowserDeclarativeExtractorTest2)));
        ...
        var context3 = new HttpDeclarativeParsingContext(method3, [],
            new HttpDeclarativeMetadata(method3, typeof(ISimulateBrowserDeclarativeExtractorTest2)));
        ...
        var context4 = new HttpDeclarativeParsingContext(method4, [],
            new HttpDeclarativeMetadata(method4, typeof(ISimulateBrowserDeclarativeExtractorTest2)));
