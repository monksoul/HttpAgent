...
public class HttpRemoteResultBaseContentConverterTests
{
    [Fact]
    public void New_ReturnOK()
    {
        ...
        Assert.NotNull(converter);
        Assert.True(
            typeof(IHttpContentConverter<HttpRemoteResultBase<ObjectModel>>).IsAssignableFrom(
                typeof(HttpRemoteResultBaseContentConverter<ObjectModel>)));
        Assert.True(converter.KeepsResponseAlive);
    }
