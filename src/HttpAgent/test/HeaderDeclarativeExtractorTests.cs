...
public class HeaderDeclarativeExtractorTests
{
    ...
    public void Extract_ReturnOK()
    {
        ...
        var context1 = new HttpDeclarativeParsingContext(method1, [],
            new HttpDeclarativeMetadata(method1, typeof(IHeaderDeclarativeTest)));
        ...
        var context2 = new HttpDeclarativeParsingContext(method2, [],
            new HttpDeclarativeMetadata(method2, typeof(IHeaderDeclarativeTest)));
        ...
        var context3 = new HttpDeclarativeParsingContext(method3, [],
            new HttpDeclarativeMetadata(method3, typeof(IHeaderDeclarativeTest)));
        ...
        var context4 =
            new HttpDeclarativeParsingContext(method4, [1, "furion", 31, "GuangDong", CancellationToken.None],
                new HttpDeclarativeMetadata(method4, typeof(IHeaderDeclarativeTest)));
        ...
        var context6 = new HttpDeclarativeParsingContext(method5, [new { id = 10, name = "furion" }],
            new HttpDeclarativeMetadata(method5, typeof(IHeaderDeclarativeTest)));
        ...
        var context7 = new HttpDeclarativeParsingContext(method6, [],
            new HttpDeclarativeMetadata(method6, typeof(IHeaderDeclarativeTest)));
...
public interface IHeaderDeclarativeTest : IHttpDeclarative
{
    ...
    Task Test4([Header] int id, [Header] [Header(AliasAs = "myName")] string name, [Header(Value = 30)] int? age,
        [Header("address")] string abc, [Header] CancellationToken cancellationToken);
