...
public class PropertyDeclarativeExtractorTests
{
    ...
    public void Extract_ReturnOK()
    {
        ...
        var context1 = new HttpDeclarativeParsingContext(method1, [],
            new HttpDeclarativeMetadata(method1, typeof(IPropertyDeclarativeTest)));
        ...
        var context2 = new HttpDeclarativeParsingContext(method2, [],
            new HttpDeclarativeMetadata(method2, typeof(IPropertyDeclarativeTest)));
        ...
        var context3 = new HttpDeclarativeParsingContext(method3, [],
            new HttpDeclarativeMetadata(method3, typeof(IPropertyDeclarativeTest)));
        ...
        var context4 =
            new HttpDeclarativeParsingContext(method4, [1, "furion", 31, "GuangDong", CancellationToken.None],
                new HttpDeclarativeMetadata(method4, typeof(IPropertyDeclarativeTest)));
        ...
        var context6 = new HttpDeclarativeParsingContext(method5, [new { id = 10, name = "furion" }],
            new HttpDeclarativeMetadata(method5, typeof(IPropertyDeclarativeTest)));
        ...
        var context7 = new HttpDeclarativeParsingContext(method6, [new { id = 10, name = "furion" }],
            new HttpDeclarativeMetadata(method6, typeof(IPropertyDeclarativeTest)));
