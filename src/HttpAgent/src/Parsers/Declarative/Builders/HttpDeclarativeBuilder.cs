...
public sealed class HttpDeclarativeBuilder
{
    ...
    internal static readonly ConcurrentDictionary<Type, IHttpDeclarativeExtractor> _extractors = new([
        ...
        new(typeof(UseETagDeclarativeExtractor), new UseETagDeclarativeExtractor()),
    ...
    internal HttpRequestBuilder Build(HttpRemoteOptions httpRemoteOptions, IServiceProvider? serviceProvider)
    {
        ...
        // 初始化 HttpDeclarativeParsingContext 实例
        var httpDeclarativeExtractorContext = new HttpDeclarativeParsingContext(Method, Args,
            new HttpDeclarativeMetadata(Method, InterfaceType), serviceProvider);
